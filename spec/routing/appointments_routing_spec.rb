...
RSpec.describe AppointmentsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #edit' do
      expect(get: '/appointments/1/edit').to route_to('appointments#edit',
                                                      id: '1')
    end
    ...
    it 'routes to #update via PATCH' do
      expect(patch: '/appointments/1').to route_to('appointments#update',
                                                   id: '1')
    end

    it 'routes to #destroy' do
      expect(delete: '/appointments/1').to route_to('appointments#destroy',
                                                    id: '1')
    end
  end
end
